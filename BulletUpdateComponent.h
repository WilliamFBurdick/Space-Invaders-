...
private:
	...
	int m_AlienBulletSpeedModifier, m_ModifierRandomComponent = 5, m_MinimumAdditionalModifier = 5;
	bool m_MovingUp = true;
public:
	bool m_BelongsToPlayer = false, m_IsSpawned = false;
